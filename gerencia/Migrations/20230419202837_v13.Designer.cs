...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WinFormsApp4.model.Guest", b =>
                {
                    b.HasOne("WinFormsApp4.model.Evento", "Evento")
                        .WithMany("Guests")
                        .HasForeignKey("IdEvento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WinFormsApp4.model.Usuario", "UsuarioConvidado")
                        .WithMany()
                        .HasForeignKey("UsuarioConvidadoIdUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
